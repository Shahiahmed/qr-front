...
export type LandingCopy = {
  ...
  reviewsTitle: string;
  reviewsSub: string;
  reviewItems: { quote: string; name: string; role: string }[];
  priceKicker: string;
  priceTitle: string;
  priceSub: string;
  popular: string;
...
const RU: LandingCopy = {
  ...
  features: [
    ...
    {
      title: "Работает без приложения",
      text: "Гость сканирует и открывает меню в браузере — ничего ставить не нужно.",
    },
    {
  ...
  reviewsTitle: "Что говорят заведения",
  reviewsSub: "Владельцы кафе и ресторанов — о работе с QR-меню.",
  reviewItems: [
    {
      quote:
        "Перешли на QR-меню и забыли про перепечатку. Поменять цену или убрать блюдо из стоп-листа — пара секунд с телефона.",
      name: "Айгерим",
      role: "кофейня, Алматы",
    },
    {
      quote:
        "Гостям удобно, что меню сразу на двух языках. Настроили за вечер по шаблону, оборудование не понадобилось.",
      name: "Данияр",
      role: "ресторан, Астана",
    },
    {
      quote:
        "Табличку с QR поставили на столы — заказы стали быстрее, официанты не бегают с бумажным меню.",
      name: "Марат",
      role: "кафе, Шымкент",
    },
  ],
  ...
  ctaSub: "Соберите меню, сгенерируйте QR и поставьте его на столы — всё за один вечер.",
  ctaBtn: "Начать бесплатно",
  ctaPoints: ["Пробная неделя бесплатно", "Без карты и предоплаты", "Готово за 10 минут"],
  footLinks: [
...
const KZ: LandingCopy = {
  ...
  features: [
    ...
    {
      title: "Қосымшасыз жұмыс істейді",
      text: "Қонақ сканерлеп, мәзірді браузерден ашады — ешнәрсе орнатудың қажеті жоқ.",
    },
    {
  ...
  reviewsKicker: "Пікірлер",
  reviewsTitle: "Мекемелер не дейді",
  reviewsSub: "Кафе мен мейрамхана иелері QR-мәзірмен жұмыс туралы.",
  reviewItems: [
    {
      quote:
        "QR-мәзірге көштік те, қайта басып шығаруды ұмыттық. Бағаны өзгерту немесе тағамды стоп-параққа қою — телефоннан бірнеше секунд.",
      name: "Айгерім",
      role: "кофехана, Алматы",
    },
    {
      quote:
        "Мәзірдің бірден екі тілде болғаны қонақтарға ыңғайлы. Үлгі бойынша бір кеште баптадық, жабдық қажет болмады.",
      name: "Данияр",
      role: "мейрамхана, Астана",
    },
    {
      quote:
        "QR тақташасын үстелдерге қойдық — тапсырыстар жылдамдады, даяшылар қағаз мәзірмен жүгірмейді.",
      name: "Марат",
      role: "кафе, Шымкент",
    },
  ],
  ...
  ctaSub: "Мәзірді жинаңыз, QR жасаңыз да, оны үстелдерге қойыңыз — бәрі бір кеште.",
  ctaBtn: "Тегін бастау",
  ctaPoints: ["Тегін сынақ аптасы", "Картасыз және алдын ала төлемсіз", "10 минутта дайын"],
  footLinks: [
